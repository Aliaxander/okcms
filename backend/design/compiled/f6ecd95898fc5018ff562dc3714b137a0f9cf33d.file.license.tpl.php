<?php /* Smarty version Smarty-3.1.18, created on 2017-08-01 18:26:03
         compiled from "backend/design/html/license.tpl" */ ?>
<?php /*%%SmartyHeaderCode:139230340259809d8bf035c0-72591281%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f6ecd95898fc5018ff562dc3714b137a0f9cf33d' => 
    array (
  ...
  'nocache_hash' => '139230340259809d8bf035c0-72591281',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59809d8bf2a531_77174885',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59809d8bf2a531_77174885')) {function content_59809d8bf2a531_77174885($_smarty_tpl) {?><?php $_smarty_tpl->tpl_vars['meta_title'] = new Smarty_variable($_smarty_tpl->tpl_vars['btr']->value->license_lecense, null, 1);
    ...
    <div class="col-lg-7 col-md-7">
        <div class="wrap_heading">
            <div class="box_heading heading_page">
                <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->license_lecense, ENT_QUOTES, 'UTF-8', true);?>

            </div>
            <div class="box_btn_heading">
                <a class="btn btn_small btn-info" target="_blank" href="http://okay-cms.com/check?domain=<?php echo htmlspecialchars($_SERVER['HTTP_HOST'], ENT_QUOTES, 'UTF-8', true);?>
">
                <i class="fa fa-link"></i>
                <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->license_check, ENT_QUOTES, 'UTF-8', true);?>
</span>
            </a>
            </div>
        </div>
                ...
                <div class="heading_box">
                    <?php if ($_smarty_tpl->tpl_vars['license']->value->valid) {?>
                        <div class="text_success">
                            <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->index_valid, ENT_QUOTES, 'UTF-8', true);?>
 <?php if ($_smarty_tpl->tpl_vars['license']->value->expiration!='*') {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->license_to, ENT_QUOTES, 'UTF-8', true);?>
 <?php echo $_smarty_tpl->tpl_vars['license']->value->expiration;?>
<?php }?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->license_on, ENT_QUOTES, 'UTF-8', true);?>
...
<?php if (!$_smarty_tpl->tpl_vars['d']->last) {?>, <?php }?><?php } ?>
                    ...
                    <?php } else { ?>
                        <div class="text_warning">
                            <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->index_not_valid, ENT_QUOTES, 'UTF-8', true);?>
                ...
                <div class="toggle_body_wrap on fn_card">
                    <div class="row">
                        <div class="col-md-12 mb-h">
                            <textarea name="license" class="form-control okay_textarea mb-h" rows="5"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value->license, ENT_QUOTES, 'UTF-8', true);?>
</textarea>
                        </div>
                    </div>
                    <div class="row">
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="boxed fn_toggle_wrap min_height_335px">
            <div class="heading_box">
                <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->license_text, ENT_QUOTES, 'UTF-8', true);?>
